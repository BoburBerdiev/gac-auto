...
const NewsCard = ({news}) => {
    ...
    return (
        <Link href={`/news/${news?.slug}`} className={'bg-white w-full h-fit border border-[#d2d2d2]  md:hover:shadow-xl group'}>
            ...
            <div className={'p-4   xl:px-7 xl:pt-6 2xl:px-9 2xl:pt-8'}>
