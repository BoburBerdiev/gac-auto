...
const ToTop = () => {
    ...
    return (
        <>
        {/* <div onClick={toTopHandle} className={`flex items-center gap-2 z-50 bg-[#c31e1a] pr-2.5 ${!isHidden ? '-right-full' : 'right-[0%]'} duration-500 bottom-[4%] py-2.5 pl-4 text-white fixed  rounded-l-full 3xl:text-lg cursor-pointer 3xl:pl-[18px] font-bold !leading-[1]`}>
            <span>{t('toTop')}</span>
